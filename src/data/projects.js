...
export const projects = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'honest limit: two people typing words into the same gap at the same instant can interleave letters. every replica agrees on the result; sequence CRDTs like RGA exist to prevent it.',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'benchmarked from the source file itself: 0.44 ms per frame at 400x300 and about 3 ms at 1080p, so the small framebuffer is a look, not a limit.',
    ],
